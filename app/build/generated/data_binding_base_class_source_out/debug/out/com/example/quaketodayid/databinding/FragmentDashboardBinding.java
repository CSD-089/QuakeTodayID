...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout fragmentDashboard;

  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavView, @NonNull ConstraintLayout fragmentDashboard) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout fragmentDashboard = (ConstraintLayout) rootView;

      return new FragmentDashboardBinding((ConstraintLayout) rootView, bottomNavView,
          fragmentDashboard);
    }

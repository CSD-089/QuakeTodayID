 ...
 */
public abstract class Hilt_TerbaruFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TerbaruFragment() {
    super();
  }

  Hilt_TerbaruFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TerbaruFragment_GeneratedInjector) this.generatedComponent()).injectTerbaruFragment(UnsafeCasts.<TerbaruFragment>unsafeCast(this));
    }
  }

 ...
 */
public abstract class Hilt_DirasakanFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DirasakanFragment() {
    super();
  }

  Hilt_DirasakanFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DirasakanFragment_GeneratedInjector) this.generatedComponent()).injectDirasakanFragment(UnsafeCasts.<DirasakanFragment>unsafeCast(this));
    }
  }

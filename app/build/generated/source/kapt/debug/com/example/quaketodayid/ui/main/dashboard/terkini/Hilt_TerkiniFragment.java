 ...
 */
public abstract class Hilt_TerkiniFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TerkiniFragment() {
    super();
  }

  Hilt_TerkiniFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TerkiniFragment_GeneratedInjector) this.generatedComponent()).injectTerkiniFragment(UnsafeCasts.<TerkiniFragment>unsafeCast(this));
    }
  }
